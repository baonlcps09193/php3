...
Route::get("/hs", 'HsController@hs');
Route::post("/hs", 'HsController@hs_store')->name('hs_store');
Route::get("/sv", 'SvController@sv');
Route::post("/sv", 'SvController@sv_store')->name('sv_store');