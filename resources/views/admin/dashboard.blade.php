...
<div class="row row-sm">
    <div class="col-lg-8">
      <div class="row row-sm">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body pd-b-0">
              <h6 class="card-body-title tx-12 tx-spacing-2 mg-b-20 tx-success">Doanh thu</h6>
              <h2 class="tx-lato tx-inverse">323,360</h2>
              <p class="tx-12"><span class="tx-success">2.5%</span> so với hôm qua</p>
            </div><!-- card-body -->
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body pd-b-0">
              <h6 class="card-body-title tx-12 tx-spacing-2 mg-b-20 tx-danger">Doanh thu</h6>
      ...
      <div class="card pd-20 pd-sm-40 mg-t-20">
        <h6 class="card-body-title">Doanh thu trong tuần</h6>
        <p class="mg-b-20 mg-sm-b-30">Hiển thị doanh thu trong tuần của website bạn</p>
      ...
      <div class="row row-sm mg-t-20">
        <div class="col-lg-6">
          <div class="card pd-20">
            <h6 class="tx-12 tx-uppercase tx-info tx-bold mg-b-15">Báo cáo</h6>
            <div class="d-flex mg-b-10">
              <div class="bd-r pd-r-10">
                <label class="tx-12">Hôm nay</label>
              ...
              <div class="pd-l-10">
                <label class="tx-12">Tháng này</label>
        ...
        <div class="col-lg-6 mg-t-20 mg-lg-t-0">
          <div class="card pd-20">
            <h6 class="tx-12 tx-uppercase tx-danger tx-bold mg-b-15">Báo cáo</h6>
            <div class="d-flex mg-b-10">
              <div class="bd-r pd-r-10">
                <label class="tx-12">Hôm nay</label>
                <p class="tx-lato tx-inverse tx-bold">1,898</p>
    ...
    <div class="col-lg-4">
      <div class="card pd-40 tx-center">
        ...
        <h6 class="tx-md-20 tx-inverse mg-b-20">Quản lí tài liệu</h6>
        <p class="tx-13">Quản lý tài liệu lưu trữ sao cho hiệu quả, tránh lãng phí. Quản lý tài liệu, hồ sơ, sổ sách luôn là việc làm khó khăn và tốn nhiều thời gian nhất.</p>
        <a href="" class="btn btn-default btn-block">Bắt đầu</a>
      </div><!-- card -->

      <div class="card mg-t-20">
        <div class="card-header d-flex justify-content-between">
          <span class="tx-uppercase tx-12 tx-medium tx-inverse">Tin nhắn gần đây</span>
          ...
          <div class="list-group-item">
            <div class="media">
              ...
              <div class="media-body mg-l-10">
                ...
                <p class="mg-b-0 tx-gray-500 tx-12">1 tiếng trước</p>
              </div><!-- media-body -->
            </div><!-- media -->
            <p class="mg-t-10 mg-b-0 tx-13">Các ngôn ngữ châu Âu là thành viên của cùng một gia đình. Sự tồn tại riêng biệt của họ là một huyền thoại...</p>
          </div><!-- list-group-item -->
          <div class="list-group-item">
            <div class="media">
