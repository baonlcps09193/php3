...
<html lang="en">
  ...
  <body>
    ...
    <div class="kt-sideleft-header">
      <div class="kt-logo"><a href="/quantri">ChiBao</a></div>
      ...
      <div class="kt-headpanel-right">
        ...
        <div class="dropdown dropdown-profile">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            ...
            <span class="logged-name"><span class="hidden-xs-down">{{ Auth::user()->name ?? 'Admin' }}</span> <i class="fa fa-angle-down mg-l-3"></i></span>
          </a>
          <div class="dropdown-menu wd-200">
            <ul class="list-unstyled user-profile-nav">
              <li><a href=""><i class="icon ion-ios-person-outline"></i>Chỉnh sửa</a></li>
              <li><a href=""><i class="icon ion-ios-gear-outline"></i>Cài đặt</a></li>
              <li><a href=""><i class="icon ion-ios-download-outline"></i> Tải về</a></li>
              <li><a href=""><i class="icon ion-ios-star-outline"></i> Ưa thích</a></li>
              <li><a href=""><i class="icon ion-ios-folder-outline"></i> Bõ sưu tập</a></li>
              <li><a href="/logout"><i class="icon ion-power"></i>Thoát</a></li>
            </ul>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
    ...
    <div class="kt-breadcrumb">
      <nav class="breadcrumb">
        <a class="breadcrumb-item" href="">ChiBao</a>
